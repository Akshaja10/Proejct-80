...
var length_name_of_students_array= name_of_the_students_array.length;
console.log(length_name_of_students_array);
for (var k=0; k<length_name_of_students_array; k++)
{
